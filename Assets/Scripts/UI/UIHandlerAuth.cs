...
//   // startup.
//   public class UIHandlerAuth : MonoBehaviour {
...
//     }
// // Add a boolean variable to track whether the login fields should be displayed
// private bool showLoginFields = false;
...
//         GUILayout.Space(20);
//         GUILayout.Label("Sign In Options", labelStyle);

//         GUILayout.Space(20);

//         // Show the login fields when the button is clicked
//         if (GUILayout.Button("Sign In With Email and Password"))
//         {
//             showLoginFields = true;
//         }

//         // Show login fields only if the boolean is true
//         if (showLoginFields)
//         {
//             GUILayout.BeginHorizontal();
//             GUILayout.Label("Email:", labelStyle, GUILayout.Width(Screen.width * 0.20f));
//             email = GUILayout.TextField(email, GUILayout.Height(labelStyle.fontSize * 2f));
//             GUILayout.EndHorizontal();

//             GUILayout.Space(10);

//             GUILayout.BeginHorizontal();
//             GUILayout.Label("Password:", labelStyle, GUILayout.Width(Screen.width * 0.20f));
...
//             {
//                 // Add your authentication logic here for signing in with email and password
...
//         if (GUILayout.Button("Sign In With Microsoft"))
//         {
...
//     //     // Create a custom GUIStyle to prevent word wrap
//     //     GUIStyle labelStyle = new GUIStyle(GUI.skin.label);
//     //     labelStyle.wordWrap = false;
//     //     labelStyle.fontSize = 24; 
...
//     //     GUILayout.Space(20);
//     //     GUILayout.Label("Log in to Lightbot account",labelStyle);
...
//     //       GUILayout.TextField(password, GUILayout.Height(labelStyle.fontSize*2f));
//     //     GUILayout.EndHorizontal();

//     //     GUILayout.Space(10);

//     //     // GUILayout.BeginHorizontal();
//     //     // GUILayout.Label("Display Name:", labelStyle, GUILayout.Width(Screen.width * 0.20f));
//     //     // displayName = GUILayout.TextField(displayName, GUILayout.Height(labelStyle.fontSize*2f));
//     //     // GUILayout.EndHorizontal();

//     //     // GUILayout.Space(10);

//     //     // GUILayout.BeginHorizontal();
//     //     // GUILayout.Label("Phone Number:", labelStyle, GUILayout.Width(Screen.width * 0.20f));
//     //     // phoneNumber = GUILayout.TextField(phoneNumber, GUILayout.Height(labelStyle.fontSize*2f));
//     //     // GUILayout.EndHorizontal();

//     //     // GUILayout.Space(10);

//     //     // GUILayout.BeginHorizontal();
//     //     // GUILayout.Label("Phone Auth Received Code:", labelStyle, GUILayout.Width(Screen.width * 0.20f));
//     //     // receivedCode = GUILayout.TextField(receivedCode, GUILayout.Height(labelStyle.fontSize*2f));
//     //     // GUILayout.EndHorizontal();
...
//         logArea = new Rect(Screen.width * 0.5f, 0.0f, Screen.width, Screen.height);
//       }
